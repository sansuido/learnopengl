...
int main() {
  ...
  var image = decodeJpg(File('resources/textures/container.jpg').readAsBytesSync());
  gldtTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, image.width, image.height, 0, GL_RGB, image.getBytes(format: Format.rgb));
