...
int main() {
  ...
  var lightingShader = Shader(
    vertexFilePath: 'resources/shaders/3.2.materials.vs',
    fragmentFilePath: 'resources/shaders/3.2.materials.fs',
  );
  var lightCubeShader = Shader(
    vertexFilePath: 'resources/shaders/3.2.light_cube.vs',
    fragmentFilePath: 'resources/shaders/3.2.light_cube.fs',
  );
  ...
  while (quit == false) {
    ...
    lightingShader.use();
    lightingShader.setVector3('light.position', gLightPos);
    lightingShader.setVector3('viewPos', gCamera.position);
    // light properties
    // note that all light colors are set at full intensity
    lightingShader.setVector3('light.ambient', Vector3(1.0, 1.0, 1.0));
    lightingShader.setVector3('light.diffuse', Vector3(1.0, 1.0, 1.0));
    lightingShader.setVector3('light.specular', Vector3(1.0, 1.0, 1.0));
    // material properties
    lightingShader.setVector3('material.ambient', Vector3(0.0, 0.1, 0.06));
    lightingShader.setVector3(
        'material.diffuse', Vector3(0.0, 0.50980392, 0.50980392));
    lightingShader.setVector3(
        'material.specular', Vector3(0.50196078, 0.50196078, 0.50196078));
